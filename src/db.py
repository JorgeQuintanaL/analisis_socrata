...
class MariaDB_Connect:
    ...
    def update_dataset(self, id_, updated_date, updated):
        query = self.dataset.update().where(self.dataset.columns.id == id_).values({"updated_date": updated_date, "updated": updated})
